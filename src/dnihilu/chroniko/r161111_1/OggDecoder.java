...
/**
 * The <code>OggDecoder</code> thread class will simply download and play
 * OGG media. All you need to do is supply a valid URL as the first argument.
 * 
 * @author Jon Kristensen
 * @version 1.0
 */
public class OggDecoder extends Thread
{
	 ...
	 */
	OggDecoder(String pUrl, MusicSystem mixer) throws IOException
	{
	 ...
	 */
	private void configureInputStream(URL pUrl) throws IOException
	{
